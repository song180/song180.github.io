window.onload = function (){
	...
	container.onmousemove = function (e){
		...
		if(document.body.scrollTop==0){
			var toTop = cy - container.offsetTop - box.offsetTop - move.offsetHeight / 2-50;
		}else{
			var toTop = cy - container.offsetTop - box.offsetTop - move.offsetHeight / 2 -50  + document.body.scrollTop;
		}
	...
	window.onscroll = function(){
		...
		console.log(document.body.scrollTop)
		if(hei>=1045){
			$('.producepageright').attr("top","1300");
			//rightt.style.top = 1300 + 'px';
		}
	}
